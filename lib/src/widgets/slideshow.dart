// import 'package:disenios2/src/models/slider_model.dart';
import 'dart:ffi';
...
class _Dot extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sShowodel = Provider.of<_SliderModel>(context);
    double tamano;
    Color color;

    if (sShowodel.currentPage >= index - 0.5 &&
        sShowodel.currentPage < index + 0.5) {

      tamano = sShowodel.bulletPrimario;
       color =  sShowodel.colorPrimario;
    }else{
      tamano = sShowodel.bulletSecundario;
       color =  sShowodel.colorSecundario;
    }
